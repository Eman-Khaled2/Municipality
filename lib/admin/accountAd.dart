...
class AccountAdScreen extends StatefulWidget {
  static String routeName = "/accountad";

  const AccountAdScreen({Key? key, required this.userData}) : super(key: key);

  final Map<String, dynamic> userData;

  @override
  State<AccountAdScreen> createState() => _AccountAdScreenState();
}

class _AccountAdScreenState extends State<AccountAdScreen> {
