...
class UserInputPage2 extends StatefulWidget {
  static String routeName = "/user_input2";

  const UserInputPage2({Key? key, required this.userData, required String pageTitle}) : super(key: key);

  final Map<String, dynamic> userData;

  State<UserInputPage2> createState() => _UserInputPage2();
}

class _UserInputPage2 extends State<UserInputPage2> {
 ...
 Future<int> fetchSubscriptionFee() async {
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          'serviceName': 'Street paving', // Provide the service name
        }),
