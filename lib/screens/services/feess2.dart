...
class feess2 extends StatefulWidget {
  static String routeName = "/fees2";

  const feess2({Key? key, required this.userData}) : super(key: key);

  final Map<String, dynamic> userData;

  @override
  State<feess2> createState() => _Fees2ScreenState();
}

class _Fees2ScreenState extends State<feess2> {
  ...
  Future<int> fetchSubscriptionFee() async {
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          'serviceName': 'Fees request to amend data', // Provide the service name
        }),
